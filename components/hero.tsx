...
export default function Hero() {
  ...
  return (
    <>
      {/* === SEO Metadata === */}
      <Head>
        <title>TIT Excellence Incubation Cell | Innovation Hub</title>
        <meta
          name="description"
          content="Welcome to TIT Excellence Incubation Cell — empowering students to innovate, collaborate, and transform ideas into impactful ventures through guidance, events, and resources."
        />
        <meta
          name="keywords"
          content="Incubation Cell, TIT Excellence, Innovation Hub, Startup Support, Student Innovation, Entrepreneurship"
        />
        <meta name="author" content="TIT Excellence Incubation Cell" />

        {/* Open Graph for social sharing */}
        <meta property="og:title" content="TIT Excellence Incubation Cell" />
        <meta
          property="og:description"
          content="Nurturing entrepreneurial minds and transforming ideas into impactful ventures."
        />
      ...
      >
        ...
        >
          <motion.div
            ...
            aria-label="Welcome message for Innovation Hub"
          >
          ...
          >
            Nurturing entrepreneurial minds and transforming ideas into
            impactful ventures. Empowering students to innovate, collaborate,
            and lead the future.
          </motion.p>
          ...
          >
            <a
              ...
              aria-label="Explore events hosted by the Incubation Cell"
            >
              Explore Events
            </a>
            <a
